...
p.multiply('LIA::R',2e6,replace=True,header='r')
q.multiply('LIA::R',2e6,replace=True,header='r')
...
q.plot_xy('Control','Theta',label = None,title=None,figure=3,linestyle='-',color='r')
p.plot_xy('Control','Theta',label = None,title=None,figure=3,linestyle='-',color='k')
p.xlabel = r'$\mu_o$H (T)'
p.ylabel = r'$\theta$ (deg)'
