...
from numpy import sqrt,chararray
import itertools
...
class JTBPlotStyle(DefaultPlotStyle):
    ...
    template_xtick_major_pad=3
    template_ytick_major_pad=3
    ...
    template_axes_labelsize=11
    template_axes_labelpad=1
    template_axes_formatter_limits=(-4, 4)
    template_axes_grid=False
    template_axes_color__cycle=['b','r','g','k','c','m','y']
    ...
    template_legend_loc          ='upper right'
